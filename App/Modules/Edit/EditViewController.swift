...
//        stackView.spacing = 16
    ...
    func addSubViews() {
        ...
        eventDateView.addSubview(eventDateTextField)
    ...
    func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            eventDateTextField.topAnchor.constraint(equalTo: eventDateLabel.bottomAnchor),
            eventDateTextField.leadingAnchor.constraint(equalTo: eventDateView.leadingAnchor),
            eventDateTextField.trailingAnchor.constraint(equalTo: eventDateView.trailingAnchor),
            eventDateTextField.bottomAnchor.constraint(equalTo: eventDateView.bottomAnchor),
            eventDateTextField.heightAnchor.constraint(equalToConstant: 50),
...
//        flexibleSpacer2.backgroundColor = .systemPurple
        ...
        eventDateTextField.backgroundColor = .systemMint
